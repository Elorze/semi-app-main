export default defineEventHandler(async (event) => {
    ...
    try {
        ...
        const url = `https://api-optimistic.etherscan.io/v2/api?chainid=10&module=account&action=txlist&address=${safeAddress}&startblock=0&endblock=99999999&sort=desc&apikey=66N5FRNV1ZD4I87S7MAHCJVXFJ`
