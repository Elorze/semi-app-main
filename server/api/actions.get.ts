export default defineEventHandler(async (event) => {
    ...
    try {
        ...
        const url = `https://api-optimistic.etherscan.io/api?module=account&action=txlist&address=${safeAddress}&startblock=0&endblock=99999999&sort=desc&apikey=66N5FRNV1ZD4I87S7MAHCJVXFJ`
